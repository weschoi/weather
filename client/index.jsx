...
class App extends React.Component {
  ...
  returnCities() {
    return this.state.cities.map((city, index) => <div key={index} onClick={() => this.switchCity(city)}>{city}</div>)
  }
      ...
      <div>
        <div className="row no-gutters justify-content-center align-items-center">
          <div className="col-sm-6 col-10">
            ...
            <div>
              <h1>{state[selectedCity] ? state[selectedCity].current.temp_f : ''}<sup>o</sup></h1>
