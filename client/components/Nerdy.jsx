      ...
      <div className="col-md-6 nerdy">
        <div className="nerdy-container">
          ...
          <div className="n-button-group">
            ...
            <div className="n-button-row">
              <div className="nerdy-button-1">M+</div>
              <div className="nerdy-button-1">M-</div>
              <div className="nerdy-button-1">MR</div>
              <div className="nerdy-button-1">MC</div>
              <div className="nerdy-button-1">+/-</div>
            </div>

            <div className="n-button-row">
              <div className="nerdy-button-1">S</div>
            ...
            <div className="n-button-row">
              ...
              <div className="nerdy-button-1">x</div>
            </div>

            <div className="n-button-row">
              <div className="nerdy-button-1">1/x</div>
            ...
            <div className="n-button-row">
              <div className="nerdy-button-1">CE</div>
